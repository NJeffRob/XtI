-- main class that all functions inherit from; design new sh function options from this!
sh = {}

function sh:sh_generator (account, ntasks, mem_per_cpu, time, calc_type, program, io_name)
    local sh_file = io.open(io_name .. ".sh", "w")
...
-- children of the parent sh class
orca = sh
orca:sh_generator("test", "test", "test", "test", "test", "test", "test")
